...
export const resources = {
  en: {
    translation: {
      ...
      getterStartedTwoHead: 'How do I join Brainlist and start editing IQ.wiki?',
     ...
     advancedFAQOneBody: "Before you can edit an IQ.wiki article you'll need to log in with your Brainlisted Polygon address using MetaMask or Walletconnect. Editing an article is quite similar to creating an article. The only difference is that you need to start with an existing IQ.wiki article and open the Edit Mode instead of starting with the Create Wiki button.",
     advancedFAQTwoHead: 'Editing Mode',
     advancedFAQTwoBody: 'To open the Editing Mode and start editing an IQ.wiki article click the "Edit" button. To learn the basics of editing on IQ.wiki, how to add a featured image, information, and citations as well as how to submit your page, first make sure to read the Creating an Article of this FAQ page.',

     advancedFAQThreeHead: 'Headers and Sections',
     advancedFAQThreeBody: "You can use headers like Overview, Use Cases, and Tokenomics, to create different sections on your wiki and make it easier to read. To add a header click the H button, choose the appropriate size and type in the title of the section. You can use H1 to H6 to create subsections as part of the original section. Use “paragraph” for the plain text. https://www.youtube.com/watch?v=qshwjtDtNss ",

     advancedFAQFourHead: 'Quotes',
     advancedFAQFourBody: "Quotes are a great way to add the perspectives of the people/companies involved or covered in the wiki. To add a quote select the quoted information and click the blockquote button. https://www.youtube.com/watch?v=P1yHumUmO6k",

     advancedFAQFiveHead: 'Adding Links to the Infobox',
     advancedFAQFiveBody: "Users can add social media links (such as Instagram, Reddit etc), contract URLs and links to the biggest crypto trackers (such as Coinmarketcap and Coingecko) within the Edit Wiki Details panel. To add a link to the infobox, choose the network from the list, insert the link and press Add. You can add a direct Twitter feed to the wiki by adding a Twitter handle to the list of social media links located within the Edit Wiki Details menu just underneath the main image. https://www.youtube.com/watch?v=q269vk780Nk ",

      advancedFAQSixHead: 'Adding Item to the Media Gallery',
     advancedFAQSixBody: "To add an image to the media gallery, navigate to the media gallery on the right side of the article (below the main image) and click new “Add images/video”. You can drag and drop an image or video or click to select it from your PC. You can paste a YouTube or image link as well as the system will automatically fetch the media.",
