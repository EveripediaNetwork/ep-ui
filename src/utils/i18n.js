...
export const resources = {
  en: {
    translation: {
      ...
      faqSectionTwo: 'Using IQ.wiki',
      faqSectionThree: 'Advanced',
      getterStartedOneHead: 'What is IQ.wiki?',
      getterStartedOneBody:
        'IQ.wiki encyclopedia is the largest Web3 encyclopedia and the leading encyclopedia in the crypto space with a wealth of encyclopedia pages. At Everipedia, our mission is to bring the world’s knowledge on-chain through the IQ token.',
