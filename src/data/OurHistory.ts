...
export const OurHistoryData: OurHistoryType[] = [
  {
    year: 2014,
    content:
  ...
  },
  {
    year: 2017,
    content:
      'In December 2017, we announced our plan for Everipedia to become the world’s first blockchain encyclopedia in an exclusive with <Link href="https://www.wired.com/story/everipedia-blockchain/">Wired.</Link>',
  },
  {
    year: 2018,
    content:
