...
const EventFilter = () => {
  ...
  return (
    <div>
      ...
      <div className="border flex flex-col border-gray200 dark:border-alpha-300 bg-white dark:bg-gray700 px-3 md:px-6 xl:px-3 py-6 xl:pt-5 xl:pb-20 mt-6 rounded-xl">
        <div className="flex justify-between flex-wrap xl:flex-col gap-x-4 gap-y-6 md:gap-8">
