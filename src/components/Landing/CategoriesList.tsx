    ...
    <div className="flex flex-col gap-10 container mx-auto py-0 lg:py-20 relative px-4 lg:px-8 2xl:px-0">
      ...
      <Tabs defaultValue={AllCategoriesData[0].id}>
        <div className="overflow-x-auto">
          <TabsList className="space-x-2 mb-12 overflow-x-auto">
            ...
            <Link
              href="/categories"
              className="flex items-center gap-2 rounded-full w-24 lg:w-full px-4 py-2.5 text-sm text-gray600 dark:text-gray-300 group h-9 border dark:border-gray-700 border-gray-200/20 bg-gray-100 dark:bg-alpha-50"
            >
              View all
              <ArrowRightIcon className="w-3 h-3 transition-transform group-hover:translate-x-1 duration-300 ease-in-out delay-150 hidden md:block" />
            </Link>
          </TabsList>
        </div>
