        ...
        <Flex gap={10} flexDirection={{ base: 'column', lg: 'row' }}>
          <Flex gap={5} flex="3" flexDirection="column">
            ...
            <Text>
              <UnorderedList>
                <ListItem>
                  ...
                  personal information, but you must create an account in order
                  to access some of the features of our site. When you create an
                  account, we may collect personal information, such as your
                  email address, user name and password and date of birth. If
                  you take part in any interactive features of the Services
                  (such as any contests, games, promotions, quizzes, surveys,
                  research or other services or features), we may collect
                  additional types of personal information. We may also collect
                ...
                <ListItem>
                  ...
                  personal narrative. You control how much personally
                  identifying information you wish to provide in your public
                  profile. We may collect User Content you provide on the
                  Website and we may display it publicly on your user Profile.
                  For example, your profile page may display information about
                  the pages, artists, or works upon which you have commented.
                  Such information may include &quot;favorites&quot; such as
                  artists, songs and lines. Other users can post to a wall in
                  this profile, where the public can view references to your
                  comments you have made on the Website. If you chose to connect
                  your social media account to your profile, we may also display
                  information from your social media sites such as Facebook and
                  Twitter.
                </ListItem>
                <ListItem>
                  ...
                  picture, gender, user name, user ID associated with your
                  social media account, age range, language, country, friends
                  list, and any other information you permit the social network
                  to share with third parties. The data we receive is dependent
                  upon your privacy settings with the social network. You should
                  always review, and if necessary, adjust your privacy settings
                  on third-party websites and services before linking or
            ...
            <Text>
              ...
              communicate with you directly, such as by responding to a request
              or by providing updates on your IQ or pages you have previously
            ...
            <Text>
              ...
              you visit our website or use our Service. When you visit the
              Service, we may send one or more cookies &mdash; a small text file
              containing a string of alphanumeric characters &mdash; to your
              ...
              cookie may also convey information to us about how you use the
              Service (e.g., the pages you view, the links you click and other
              actions you take on the Service), and allow us to track your usage
              of the Service over time. We may collect log file information from
              ...
              your web request, Internet Protocol (&quot;IP&quot;) address,
              browser type, identity of your internet service provider,
              information about your mobile device, referring / exit pages and
              URLs, the number and duration of page views, number of clicks and
              how you interact with links on the Service, domain names, landing
              pages, and other such information. When you access our site
              through a mobile device, we may receive or collect and store a
              unique identification number associated with your device and other
              device information. We may also employ clear gifs (also known as
              ...
              HTML-based emails sent to our users to track which emails are
              ...
              data and clear gifs information to: (a) remember information so
              that you will not have to re-enter it during your visit or the
              next time you visit the site; (b) customize your user experience;
              (c) provide and monitor the effectiveness of our Service; (d)
              monitor aggregate metrics such as total number of visitors,
              traffic, usage, and demographic patterns on our website and our
              Service; (e) diagnose or fix technology problems; and (f)
              otherwise to plan for, improve and enhance our service. We may
              associate information we automatically collect with your other
              information.
            </Text>
            <Heading as="h2" size="md">
            ...
            <Text>
              ...
              Information&quot; section below. Remember, our Services allow you
              to connect with others and share information about yourself with
              other individuals. Your profile information, including your user
              name, photo, and personal narrative, and comments you make on the
              Website, will be available publicly to other members of the
              Service by default and may be searchable by search engines which
              may display your information publicly. Similarly, your name and
              photo will be displayed alongside any comments you make on the
              Website and may be displayed on our homepage alongside your IQ if
              you make The Weekly IQ Leaderboard, on our Contributors list, or
              in connection with your comments and reactions to our blog and to
              other contributors. By using the Service, you consent to have your
              profile information displayed publicly.
            </Text>
            ...
            <Text>
              ...
              &quot;unsubscribe&quot; button on promotional email
              communications. Note that you will not be able to unsubscribe or
              opt-out of non-promotional messages regarding your account, such
              as account verification, password reminders, changes or updates to
              features of the Service, or technical and security notices.
            </Text>
            <Text>
              As of August 2015, IQ.wiki does not share your personal
              information with third parties for advertising purposes, however
              we reserve the right to share your personal information, such as
              email address and user name, with third parties for their
              marketing purposes in the future if we determine that there may be
              additional products or services which may be of interest to you.
              If you wish to have your user name and email address excluded from
              any such future sharing with partners, please email
              webmaster@everipedia.com with the subject &quot;Direct Marketing
              Opt-Out.&quot; We will not send you an individualized notification
              that this policy is being updated if we elect to share information
              with a partner in this manner, so you must opt-out now. If you
              have any questions about this opt-out or our marketing practices,
              please email us at webmaster@everipedia.com.
            </Text>
            <Text>
              ...
              cookies or similar tracking technologies. The only way to
              completely &quot;opt out&quot; of the collection of any
              ...
              Please refer to your browser&apos;s or mobile device&apos;s
              technical information for instructions on how to delete and
              disable cookies, and other tracking/recording tools. (To learn
              more about behavioral advertising and to learn how to opt-out, you
              may wish to visit{' '}
            ...
            <Text>
              ...
              from you for behavioral advertising purposes, though we may
              collect persistent identifiers from your browser or mobile device
              to assist us with providing and improving the Service. Because we
              collect browsing and persistent identifier data only for analytic
              and internal purposes, your selection of the &quot;Do Not
              Track&quot; option provided by your mobile browser will not have
              any effect on our collection of analytics information or the
            ...
            <Text>
              ...
              information within a reasonable time after your request. Because
              of the crowd-sourced and collaborative nature of our service,
              however, we will not be able to delete content you post to public
              areas of our site. We may be able to anonymize your information
