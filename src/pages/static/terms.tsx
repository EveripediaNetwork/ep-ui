      ...
      <Flex gap={10} flexDirection={{ base: 'column', lg: 'row' }}>
        <Flex gap={5} flex="3" flexDirection="column">
          <Text>
            ...
            &quot;Terms&quot;) and to the collection, use, and disclosure of
            your information as set forth in our Privacy Policy, as modified
            ...
            Service (&quot;Users&quot;). If you are a United States Federal
            Agency, this Amendment is applied to the Terms of Service. We
            provide the Service for your use subject to the following Terms. We
            reserve the right, in our sole discretion, to change or modify
            portions of these Terms at any time. If we modify these Terms, we
            will post a notice at the top of our Service for a period of seven
            (7) days. Your continued use of the Service constitutes your
            acknowledgement of, acceptance of, and agreement to the revised
            Terms. You agree to periodically visit this page to review the
            current Terms so you are aware of any revision to which you are
            ...
            are hereby incorporated by reference into these Terms. PLEASE READ
            THESE TERMS CAREFULLY TO ENSURE THAT YOU UNDERSTAND EACH PROVISION.
          ...
          <Text>
            ...
            older. Any registration by, use of or access to the Service by
            anyone under 13 is unauthorized and in violation of these Terms. By
            using the Service, you represent and warrant that you are 13 years
            of age or older.
          </Text>
          <Heading as="h2" size="md">
