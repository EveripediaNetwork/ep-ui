export const BrainPassABI = [
  {
    inputs: [{ internalType: 'address', name: 'IqAddr', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  { inputs: [], name: 'AlreadyMintedAPass', type: 'error' },
  { inputs: [], name: 'CannotMintPausedPassType', type: 'error' },
    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: 'uint256',
            name: 'lastTokenIdMinted',
            type: 'uint256',
          },
          { internalType: 'uint256', name: 'currentNftCount', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'maxTokens', type: 'uint256' },
      { internalType: 'uint256', name: 'discount', type: 'uint256' },
      { internalType: 'uint256', name: 'lastTokenIdMinted', type: 'uint256' },
      { internalType: 'uint256', name: 'currentNftCount', type: 'uint256' },
      { internalType: 'bool', name: 'isPaused', type: 'bool' },
    ],
    stateMutability: 'view',
